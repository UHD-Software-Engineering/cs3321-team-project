CREATE DATABASE  IF NOT EXISTS `lms_database` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `lms_database`;
-- MySQL dump 10.13  Distrib 8.0.19, for macos10.15 (x86_64)
--
-- Host: 127.0.0.1    Database: lms_database
-- ------------------------------------------------------
...
CREATE TABLE `course_departments` (
  ...
  `course_department_name` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`course_department`)
...
-- Dump completed on 2020-04-27 12:17:31
